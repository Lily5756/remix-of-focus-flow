...
import { X, Mail, Lock, User as UserIcon, Eye, EyeOff, ArrowLeft } from 'lucide-react';
...
export function AuthModal({ onClose, onSuccess }: AuthModalProps) {
  ...
  const [mode, setMode] = useState<AuthMode>(isRecoveryMode ? 'reset' : 'login');
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-background rounded-2xl overflow-hidden animate-scale-in shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          {/* Reset Password Mode - New Password Fields */}
          {mode === 'reset' && (
            <>
              <div>
